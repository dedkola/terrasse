...
const CategorySection = () => {
    const categories = [
        ...
        { name: 'Топы', href: '/tops', image: 'https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?auto=format&fit=crop&q=80&w=800' },
        { name: 'Трикотаж', href: '/knitwear', image: 'https://images.unsplash.com/photo-1574201635302-388dd92a4c3f?auto=format&fit=crop&q=80&w=800' }
    ];
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {categories.map((cat, i) => (
                    ...
                    >
                        <Link href={cat.href} className="relative block w-full h-full cursor-pointer">
                            <Image
                                src={cat.image}
                                alt={cat.name}
                                fill
