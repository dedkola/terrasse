          ...
          <div className="mt-12 pt-12 border-t border-stone-100">
            <div className="bg-stone-50 rounded-2xl p-6 space-y-4">
              ...
              <div className="space-y-3 text-sm text-brand-muted leading-relaxed">
                ...
                <p>
                  Мы обеспечиваем надёжную и быструю доставку по всей Украине с помощью Новой Почты.
                </p>
                <ul className="space-y-2">
                  ...
                  <li>Для заказа звоните - +38 (093) 803 90 68</li>
                  <li>
                    📍 Магазин находится в Киеве, Маркет Молл «Дарынок», ул. Якова Гнездовского, 1А
                  </li>
                  <li>E-mail: terrasse-shop@proton.me</li>
                </ul>
              </div>
            </div>
          </div>
