                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-24">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-brand-muted">
                            <li><a href="#" className="hover:text-black transition-colors">Новинки</a></li>
                            <li><a href="#" className="hover:text-black transition-colors">Хиты продаж</a></li>
                            <li><a href="#" className="hover:text-black transition-colors">Коллекции</a></li>
                            <li><a href="#" className="hover:text-black transition-colors">Распродажа</a></li>
                        </ul>
                    </div>
