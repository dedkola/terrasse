      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-24">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-sm text-brand-muted leading-relaxed">
              Создаем вневременные базовые вещи для современного гардероба. Качество, экологичность
              и непринужденный стиль.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-brand-muted mb-6">
              Присоединяйтесь к нашему списку для получения эксклюзивных обновлений и раннего
              доступа.
            </p>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-12 border-t border-stone-100">
          ...
          <div className="flex space-x-6">
            <Instagram
              size={18}
              className="text-brand-muted hover:text-black cursor-pointer transition-colors"
            />
            <Twitter
              size={18}
              className="text-brand-muted hover:text-black cursor-pointer transition-colors"
