              ...
              <form onSubmit={handleSave} className="space-y-7">
                ...
                <div>
                  ...
                  {newImagePreviews.length > 0 && (
                    <div className="grid grid-cols-3 gap-3 mb-3">
                      {newImagePreviews.map((src, i) => (
                        <div
                          key={i}
                          className="relative aspect-square rounded-xl overflow-hidden bg-white/5 ring-1 ring-white/30"
                        >
                          {/* eslint-disable-next-line @next/next/no-img-element */}
                          <img
                            src={src}
                          ...
                          <span className="absolute bottom-1 left-1 text-[10px] bg-white/20 text-white px-1.5 py-0.5 rounded">
                            Новое
                          </span>
                        </div>
                      ))}
                  ...
                  <input
                    ...
                    className="hidden"
                    onChange={(e) =>
                      e.target.files && handleNewFiles(e.target.files)
                    }
                  />
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  >
                    <span
                      className={`absolute top-1 left-1 w-4 h-4 rounded-full transition-transform duration-300 ${isNew ? "translate-x-6 bg-black" : "translate-x-0 bg-white"}`}
                    />
                  </button>
